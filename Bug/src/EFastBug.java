...
class EFastBug extends Bug {
    public EFastBug(JFrame myJFrame, int hitsNeeded, int directionChangeProbability){
        super(myJFrame, hitsNeeded, directionChangeProbability);//call Bug constructor
        // set up images for fase bug
        bugImageName[UP]="bug1.jpg";
        bugImageName[DOWN]="bug3.jpg";
        bugImageName[LEFT]="bug4.jpg";
        bugImageName[RIGHT]="bug2.jpg";
